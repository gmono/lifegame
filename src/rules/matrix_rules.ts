 ...
 * @param v
 */
function setZero(K,S,P,v=3){
    const T=tf_reverse(equalMap(K,v));
 ...
 */
export function useMatrixRule(ts: tf.Tensor2D, ruleF:(rule:RuleType)=>void=Rules.b3s23, logHistory=false) {
